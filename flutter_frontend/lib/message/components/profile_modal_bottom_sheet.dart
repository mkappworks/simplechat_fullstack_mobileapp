                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ProfileModalBottomSheetText(value: userModel.email),
                        ProfileModalBottomSheetText(value: userModel.name),
                        ProfileModalBottomSheetText(value: userModel.age),
                        ProfileModalBottomSheetText(value: userModel.gender),
                      ],
                    ),
                  ),
                )
